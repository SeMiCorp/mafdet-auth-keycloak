resource "keycloak_openid_client" "terraform_openid_client_mafdet" {
  lifecycle {
...
resource "keycloak_openid_client_service_account_role" "client2_service_account_role" {
  ...
  service_account_user_id = keycloak_openid_client.terraform_openid_client_mafdet.service_account_user_id
  client_id               = data.keycloak_openid_client.realm_management.id
